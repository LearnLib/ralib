...
public class DTTest {
	...
	public void siftTest() {
	      ...
	      Word<PSymbolInstance> access1 = Word.fromSymbols(
	    		  new PSymbolInstance(I_POP, new DataValue(T_INT,1)));
	      Word<PSymbolInstance> access2 = Word.epsilon();
	      ...
	      PSymbolInstance asPush1Pop1 = leaf1.getShortPrefixes().iterator().next().getPrefix().getSymbol(0);
	      ...
	      Assert.assertEquals(asPush1Pop1, access1.getSymbol(0));
