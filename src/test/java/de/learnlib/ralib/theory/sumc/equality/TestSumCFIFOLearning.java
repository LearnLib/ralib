...
//	        IOOracle ioOracle = new BasicSULOracle(sul, SumCFIFOSUL.ERROR);
	        IOOracle ioOracle= new CanonizingSULOracle(new DeterminizerDataWordSUL(teachers, consts, sul), SpecialSymbols.ERROR, new SymbolicTraceCanonizer(teachers, consts));
...
//	        		-> TestUtil.createMTOWithFreshValueSupport(sul, SumCFIFOSUL.ERROR, teachers, consts, jsolv, sul.getInputSymbols());
