...
public class LearnLoginIOTest {
    ...
    public void learnLoginExampleIO() {
        ...
        final PSymbolInstance ERROR = new PSymbolInstance(
         ...
         RaStar rastar = new RaStar(mto, null, mlo, consts, actions);
...
//         while(true) {
//         
//            Word<PSymbolInstance> ce = iowalk.findCounterExample(model);         
//         
//         }
    }    
}
