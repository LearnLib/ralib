...
public class ValueCanonizerTest  extends RaLibTestSuite {
	...
	public void testConcreteCanonizerIneq() {
        ...
        ValueCanonizer canonizer = ValueCanonizer.buildNew(teachers, consts);
	...
	public void testSymbolicCanonizerIneq() {
        ...
        Constants consts = new Constants(new SumConstants(sumConsts));
    	DataValueConstructor<Integer> b = new DataValueConstructor<>(IntHardFreshTCPSUL.INT_TYPE);
    	SymbolicValueMapper<Integer> valueMapper = new SymbolicValueMapper<Integer>(sumCTheory, IntHardFreshTCPSUL.INT_TYPE);
    	ValueCanonizer valueCanonizer = new ValueCanonizer(Collections.singletonMap(IntHardFreshTCPSUL.INT_TYPE, valueMapper), consts);
        ValueCanonizer canonizer = ValueCanonizer.buildNew(teachers, consts);
    ...
    public static void main(String [] args) {
		ValueCanonizerTest test = new ValueCanonizerTest();
		test.testConcreteCanonizerIneq();
		test.testSymbolicCanonizerIneq();
