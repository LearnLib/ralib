...
public class SumCFIFOSUL extends DataWordSUL {
    ...
    private SumCFIFOExample fifo;
    private int capacity;

	private int sumc;
    
    public SumCFIFOSUL(int capacity, int sumc) {
    ...
    public void pre() {
        countResets(1);
        fifo = new SumCFIFOExample(capacity, sumc);
    }
    ...
    public PSymbolInstance step(PSymbolInstance i) throws SULException {
        ...
        if (i.getBaseSymbol().equals(OFFER)) {
            Object x = fifo.offer((Integer) i.getParameterValues()[0].getId());
