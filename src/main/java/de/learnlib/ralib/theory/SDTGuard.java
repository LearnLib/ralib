    ...
    static SDTGuard shift(SDTGuard in, int shift) {
        ...
        return switch (in) {
            case SDTGuard.EqualityGuard guard ->
                new SDTGuard.EqualityGuard(p, shiftRegister(guard.register, shift));
            case SDTGuard.DisequalityGuard guard ->
                new SDTGuard.DisequalityGuard(p, shiftRegister(guard.register, shift));
            case SDTGuard.IntervalGuard guard ->
                new SDTGuard.IntervalGuard(p,
