 ...
 * @author falk
 */
public class ClasssAnalyzerDataWordSULNew extends DataWordSUL {
    ...
    public ClasssAnalyzerDataWordSULNew(Class<?> sulClass, Map<ParameterizedSymbol, MethodConfig> methods, int d) {
